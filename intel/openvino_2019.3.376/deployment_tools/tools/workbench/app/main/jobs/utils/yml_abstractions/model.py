...
"""
import yaml
from app.main.jobs.utils.yml_abstractions.launcher import Launcher
from app.main.jobs.utils.yml_abstractions.dataset import Dataset


class Model:
    def __init__(self, launcher: Launcher, dataset: Dataset):
