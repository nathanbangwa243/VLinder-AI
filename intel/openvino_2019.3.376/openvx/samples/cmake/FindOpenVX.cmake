option(USE_KHRONOS_SAMPLE_IMPL "Use Khronos sample OpenVX implementation instead of Intel OpenVX implementation" OFF)
...
if(NOT USE_KHRONOS_SAMPLE_IMPL)
    ...
    if(IntelOpenVX_FOUND)
        ...
        message(STATUS "[ INFO ] Intel CVSDK OpenVX implementation: not found")
    endif()
else()
    ...
    if(KhronosOpenVX_FOUND)
        ...
        message(STATUS "[ INFO ] Khronos sample OpenVX implementation: not found")
    endif()
