...
#define VX_LIBRARY_SAMPLE_MOTIONDETECTION                           (0x6)

// Motion detection parameters, users can modify for their application
#define MINIMUM_IMAGE_WIDTH                                         (16)    // Minimum image width supported by motion detection
#define MINIMUM_IMAGE_HEIGHT                                        (16)    // Minimum image height supported by motion detection
#define MAXIMUM_IMAGE_WIDTH                                         (8192)  // Maximum image width supported by motion detection
#define MAXIMUM_IMAGE_HEIGHT                                        (8192)  // Maximum image height supported by motion detection
...
enum vx_kernel_intel_sample_motion_detection_e {
    VX_KERNEL_SAMPLE_MOTIONDETECTION_CONNECTED_COMPONENT_LABELING = VX_KERNEL_BASE(VX_ID_DEFAULT, VX_LIBRARY_SAMPLE_MOTIONDETECTION) + 0x0
};
